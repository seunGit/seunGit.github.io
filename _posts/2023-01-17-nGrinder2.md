...
title: nGrinder를 활용한 성능테스트 (2) - 테스트 스크립트 작성
...
[**이전 포스트**](https://github.com/naver/ngrinder/releases)에서는 nGrinder를 사용하기 위해 `Controller`와 `Agent`를 설치하는 과정을 설명하였다.<br>
이어서 이번 포스트에는 테스트 스크립트를 작성하고 부하테스트를 진행 해보자.<br>
