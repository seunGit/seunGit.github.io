...
```
![설치오류](../../../assets/img/ngrinder/controllerinstallexception.png "설치오류"){: width="100%" height="100%"){: .center}
...
![admin로그인](../../../assets/img/ngrinder/adminlogin.png "admin로그인")
...
![에이전트실행](../../../assets/img/ngrinder/agentrun.png "에이전트실행")<br>

확인 후 에이전트 관리로 들어간다.<br>

![에이전트관리](../../../assets/img/ngrinder/agentsetting.png "에이전트관리")<br>

실행이 잘 되어있는지 확인한다.<br>

![에이전트관리2](../../../assets/img/ngrinder/agentsetting2.png "에이전트관리2")<br>
